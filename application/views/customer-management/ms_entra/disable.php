...
<div class="modal-dialog" role="document">
	<div class="modal-content">
		...
		<?php echo form_open('/customer-management/ms-entra/do-disable/'.$client_code, array('id'=>'general_action', 'role'=>'form', 'class'=>'element-action-form')); ?>
		
		<div class="modal-body">
			<h5>Disable Microsoft Entra ID API for:</h5>
