					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group<?php echo form_error('tenant_id') ? ' has-error':''; ?>">
								...
								<input type="text" class="form-control" id="tenant_id" name="tenant_id" placeholder="Enter Tenant ID" value="<?php echo set_value('tenant_id'); ?>">
							</div>
							<div class="form-group<?php echo form_error('client_id') ? ' has-error':''; ?>">
								<label class="control-label" for="client_id">Client ID</label>
								<input type="text" class="form-control" id="client_id" name="client_id" placeholder="Enter Client ID" value="<?php echo set_value('client_id'); ?>">
							</div>
							<div class="form-group<?php echo form_error('client_secret') ? ' has-error':''; ?>">
								...
								<input type="text" class="form-control" id="client_secret" name="client_secret" placeholder="Enter Client Secret" value="<?php echo set_value('client_secret'); ?>">
							</div>																	
						</div>
					</div>
					<div class="row">
