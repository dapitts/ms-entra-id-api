...
<div class="modal-dialog" role="document">
	<div class="modal-content">
		...
		<?php echo form_open('/customer-management/ms-entra/do-activate/'.$client_code, array('id'=>'general_action', 'role'=>'form', 'class'=>'element-action-form')); ?>
		
		<div class="modal-body">
			<h5>Enable Microsoft Entra ID API for:</h5>
